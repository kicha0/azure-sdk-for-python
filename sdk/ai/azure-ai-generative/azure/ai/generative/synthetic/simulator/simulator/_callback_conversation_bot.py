...
class CallbackConversationBot(ConversationBot):
    ...
    async def generate_response(
        ...
        chat_protocol_message = self._to_chat_protocol(self.user_template, conversation_history, self.user_template_parameters)
        ...
        try:
            ...
            raise TypeError("User provided callback do not conform to chat protocol standard.")
